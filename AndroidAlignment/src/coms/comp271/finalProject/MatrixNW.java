...
/* Author(s): Zach Romer and Paul Stasiuk
* Class: COMP271
...
public class MatrixNW
{
    ...
    private ArrayList<String> seqAligned1;
    private ArrayList<String> seqAligned2;
    ...
    public MatrixNW(String in1, String in2, boolean type){  
       ...
       public void findPath(){
        ...
        public void returnAligned(){
            seqAligned1= new ArrayList<String>();
            seqAligned2= new ArrayList<String>();
            System.out.print("\n" + "Sequence 1: ");
            while(!sequenceAlign1.empty()){
                //System.out.print(sequenceAlign1.pop());
            	seqAligned1.add(sequenceAlign1.pop().toString());
            }
            System.out.print("\n" +"Sequence 2: ");
            while(!sequenceAlign2.empty()){
                //System.out.print(sequenceAlign2.pop());
            	seqAligned2.add(sequenceAlign2.pop().toString());
            }
            
        }
        
        public String getAligned1(){
        	String aligned1=null;
        	aligned1=seqAligned1.get(0);
        	for(int i=1; i<seqAligned1.size(); i++){
        		aligned1=aligned1+seqAligned1.get(i);
        	}
        	System.out.println("Algined1 is: "+aligned1);
        	return aligned1;
        	
        }
        
        public String getAligned2(){
        	String aligned2=null;
        	aligned2=seqAligned2.get(0);
        	for(int i=1; i<seqAligned2.size(); i++){
        		aligned2=aligned2+seqAligned2.get(i);
        	}
        	System.out.println("Algined2 is: "+aligned2);
        	return aligned2;
