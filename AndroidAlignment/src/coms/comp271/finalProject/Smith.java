...
* 
* This is the class that runs the Smith-Waterman algorithm. It takes input in from the user(two sequences) then runs then through
...
public class Smith extends Activity{
	...
	//The TextView for the Matrix
	private TextView matrix;
	//The array for the matrix to be printed
	private int[][] arrayMatrix;
	//The text file location for the martix/information print-out
	...
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    setContentView(R.layout.smithlayout);
        ...
        align.setOnClickListener( new View.OnClickListener() {
			public void onClick(View v) {
				...
				MatrixNW alignment= new MatrixNW(seq1,seq2,true);
